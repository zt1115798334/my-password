package com.zt.mypassword.exception;
...
public class GlobalException {
    ...
    public ResultMessage dateTimeParseExceptionHandler(HttpServletResponse response, Exception ex) {
        log.error(ex.getMessage());
        ex.printStackTrace();
        return new ResultMessage().error(SystemStatusCode.SC_INTERNAL_SERVER_ERROR.getCode(), ex.getMessage());
    }
    ...
    public void bindException(ValidationException ex) {
        log.error(ex.getMessage());
